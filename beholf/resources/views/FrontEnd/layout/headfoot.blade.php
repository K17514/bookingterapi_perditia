...
<head>
    ...
    <title>Perditia - Booking Therapist</title>
...
<body>
    ...
    <ul class="menu-sub">
        ...
        @if(in_array($userLevel, [1, 2, 3]))
                  <li class="menu-item {{ request()->routeIs('users.*', 'terapis.*', 'kategoris.*') ? 'active open' : '' }}">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
    ...
    <ul class="menu-sub">
        ...
        <!-- Terapis Menu -->
        <li class="menu-item {{ request()->routeIs('terapis.*') ? 'active' : '' }}">
            <a href="{{ route('terapis.index') }}" class="menu-link">
                <div data-i18n="Without navbar">Terapi</div>
            </a>
        </li>
@endif
         @if(in_array($userLevel, [1, 3]))
        <!-- Jadwal Menu -->
        <li class="menu-item {{ request()->routeIs('jadwals.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ $user->foto ? asset('beholf/public/' . $user->foto) : asset('assets/img/avatars/1.png') }}" alt="User"
